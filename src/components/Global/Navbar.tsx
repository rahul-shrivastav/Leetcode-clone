...
const Navbar = () => {
    const islogin = false;
    return (
        <div className=" max-h-[75px] shadow-lg  shadow-gray-950 absolute top-0 w-full overflow-x-clip  flex items-center justify-between    text-white border-b border-white border-opacity-10">
