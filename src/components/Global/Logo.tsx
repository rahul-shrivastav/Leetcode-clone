...
const Logo = () => {
    return (
        <div className=" flex-col items-center justify-center hover:cursor-pointer  ">
            ...
            <div className="text-[14px] text-center pt-2 font-extralight"><span className="font-semibold text-[18px] ">C</span>ode<span className=" text-[18px]  font-semibold">A</span>rena</div>
        </div>
    );
}
